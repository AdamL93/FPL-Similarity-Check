'''transfer data for each team id in league'''
import requests
import json
...
def fetch_and_store_fpl_transfers_data(base_url, team_ids, output_file):
    all_data = []
    ...
    print(f"Transfer data for {len(team_ids)} teams saved to {output_file} successfully.")
...
if __name__ == "__main__":
    ...
    output_file = "content_creators_transfers_data.json"

    fetch_and_store_fpl_transfers_data(base_url, team_ids, output_file)
